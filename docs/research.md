...
- 미래 날짜형 arXiv ID 다수(예: 2602.x, 2604.x, 2606.x) — 검색 요약 환각 가능성, **인용 금지**. 단 **LREAD `2601.19913`은 2026-06 검증 완료**(arXiv v1~v3 페이지·GitHub `Shinwoo-Park/lread` 실재 확인, 제목·수치·루브릭 배점 본문 대조) → 인용 가능
