...
- `references/translationese-research.md` — 번역투·번역 보편소·post-editese의 학술 근거(한국 번역학·국어학, Baker·Toury, Toral 2019 등). 카테고리 1·2·6 배경 근거가 필요할 때만.
</resources>
...
4. 작업 시작 시 한 줄 상태를 출력한다: `yunmoon — 장르: {장르} / 강도: {강도}`
</phase>
...
`<output_format>`에 정의한 형식대로 사용자에게 반환한다. 등급 B 이하이거나 의미 보존이 불안하면,
